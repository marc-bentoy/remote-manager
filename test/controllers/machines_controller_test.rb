...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference("Machine.count") do
      post machines_url, params: { machine: { active: @machine.active, name: @machine.name, user_id: @machine.user_id } }, as: :json
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { active: @machine.active, name: @machine.name, user_id: @machine.user_id } }, as: :json
    assert_response :success
  end
